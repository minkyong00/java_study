...
public class NetworkMemoUI extends JFrame {

	NetworkMemoModel memoModel;
	JList<Memo> memoList;
	...
	public NetworkMemoUI() {
	}

	public NetworkMemoUI(NetworkMemoModel networkMemoModel) throws HeadlessException {
		this.memoModel = networkMemoModel;
		...
		loadButton = new JButton("메모 불러오기");
		addButton = new JButton("메모 등록");
		editButton = new JButton("메모 수정");
		deleteButton = new JButton("메모 삭제");

		addButtons(buttonPanel, loadButton, addButton, editButton, deleteButton);
